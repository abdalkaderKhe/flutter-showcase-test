      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            onChanged: (value) => presenter.userNameChange(value), //TODO
          ),
          ...
          TextField(
            ...
            onChanged: (value) => presenter.passwordChange(value), //TODO
          ),
          const SizedBox(height: 16),//state.isLoginEnabled
              stateObserver(
                builder: (context, state) {
                  if (state.isLoginEnabled) {
                    return state.isLoadingEnabled
                        ...
                        : ElevatedButton(
                            onPressed: () async =>
                                await presenter.loginClick(), //TODO
